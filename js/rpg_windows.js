...
Window_Status.prototype.drawBasicInfo = function(x, y) {
    var lineHeight = this.lineHeight();
    this.drawActorLevel(this._actor, x - 24, y + lineHeight * 0);
    this.drawActorIcons(this._actor, x - 24, y + lineHeight * 1);
    this.drawActorHp(this._actor, x - 24, y + lineHeight * 2, 238);
    this.drawActorMp(this._actor, x - 24, y + lineHeight * 3, 238);
};
...
Window_Status.prototype.drawEquipments = function(x, y) {
    ...
    for (var i = 0; i < count; i++) {
        this.drawItemName(equips[i], x, this.lineHeight() / 2 + (y + this.lineHeight() * i));
    }
};
