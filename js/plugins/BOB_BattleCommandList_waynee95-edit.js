...
Bobstah.Parameters = PluginManager.parameters(
  "BOB_BattleCommandList_waynee95-edit"
);
Bobstah.Param = Bobstah.Param || {};

Bobstah.Param.BattleCommandList_ForceDefaultCommands = Number(
  Bobstah.Parameters["Force Default Commands"]
);
Bobstah.Param.BattleCommandList_ShowHelpWindow = Number(
  Bobstah.Parameters["Show Help Window"]
);
Bobstah.Param.BattleCommandList_HelpWindowPosition = Number(
  Bobstah.Parameters["Help Window Position"]
);
Bobstah.Param.BattleCommandList_ShowIcons = Number(
  Bobstah.Parameters["Show Icons"]
);
Bobstah.Param.BattleCommandList_SkillMenuSTypes = Number(
  Bobstah.Parameters["Skill Menu STypes"]
);
Bobstah.Param.BattleCommandList_IconPadding = Number(
  Bobstah.Parameters["Icon Padding"]
);
Bobstah.Param.BattleCommandList_HelpWindowX = Number(
  Bobstah.Parameters["Help Window X"]
);
Bobstah.Param.BattleCommandList_HelpWindowY = Number(
  Bobstah.Parameters["Help Window Y"]
);
Bobstah.Param.BattleCommandList_HelpWindowHeight = Number(
  Bobstah.Parameters["Help Window Height"]
);
Bobstah.Param.BattleCommandList_HelpWindowWidth = Number(
  Bobstah.Parameters["Help Window Width"]
);
Bobstah.Param.BattleCommandList_TwoCostPosition = Number(
  Bobstah.Parameters["Two Cost Position"]
);
Bobstah.Param.BattleCommandList_ShowCosts = Number(
  Bobstah.Parameters["Show Costs"]
);
Bobstah.Param.BattleCommandList_CostFontSize = Number(
  Bobstah.Parameters["Cost Font Size"]
);
Bobstah.Param.BattleCommandList_CostOutlineStrength = Number(
  Bobstah.Parameters["Cost Outline Strength"]
);
...
//=============================================================================
function BattleCommand(cmd, ids, params, icon, hide, condition) {
  this._cmd = cmd;
  this._ids = ids;
  this._params = params;
  this._icon = icon;
...
/// Edit by waynee95
BattleCommand.prototype.enableConditionEval = function() {
  this._evalCondition = true;
};
/// Edit by waynee95
...
Object.defineProperties(BattleCommand.prototype, {
  ...
  params: {
    get: function() {
      if (this._evlParam) {
        return String(this.evaluate(this._params));
      }
      return this._params;
    },
    configurable: true
  ...
  iconOverride: {
    get: function() {
      if (this._evlIcon) {
        return Number(this.evaluate(this._icon));
      }
      if (this._icon === "wep") {
  ...
  command: {
    get: function() {
      if (this._evlCmd) {
        return String(this.evaluate(this._cmd));
      }
      return this._cmd;
    },
    configurable: true
...
Bobstah.BattleCmds.positionHelp = function(helpWindow, refWindow) {
  switch (Bobstah.Param.BattleCommandList_HelpWindowPosition) {
    ...
    case 0:
      var helpX =
        Bobstah.Param.BattleCommandList_HelpWindowX !== 0
          ? Bobstah.Param.BattleCommandList_HelpWindowX
          : helpWindow.x;
      var helpY =
        Bobstah.Param.BattleCommandList_HelpWindowY !== 0
          ? Bobstah.Param.BattleCommandList_HelpWindowY
          : helpWindow.y;
      var helpH =
        Bobstah.Param.BattleCommandList_HelpWindowHeight !== 0
          ? Bobstah.Param.BattleCommandList_HelpWindowHeight
          : helpWindow.height;
      var helpW =
        Bobstah.Param.BattleCommandList_HelpWindowWidth !== 0
          ? Bobstah.Param.BattleCommandList_HelpWindowWidth
          : helpWindow.width;
...
DataManager.processBobstahBattleCmdNotes = function(group) {
  ...
  var hideregex = /!/i; /// Edit by waynee95
  //Param Regex. Used to grab the command name out from between () if specified.
  var paramregex = /^\((.+)\)$/i;

  /// Edit by waynee95
  // Condition Regex. Used to get the condition from between {} if specified.
  var conditionRegex = /{(.+)}/i;
  /// Edit by waynee95
  ...
  for (var n = 1; n < group.length; n++) {
    ...
    if (obj.note.match(cmdlist)) {
      ...
      while ((cmdInfo = cmdregex.exec(notedata))) {
        ...
        // Exclude the condition string inside the cmdInfo[4], because it messes up the
        // ids. There might be a nicer way, but for now this is a quick fix.
        var string = cmdInfo[4].replace(conditionRegex, ""); /// Edit by waynee95

        //Split by commands to grab all of our IDs.
        if (string.indexOf("$(") !== -1) {
          string.match(evalregex);
          var ids = RegExp.$1;
          var evlIds = true;
        } else if (string.indexOf(",") !== -1) {
          var ids = [];
          while ((id = idsregex.exec(string))) {
            ids.push(Number(id[1]));
          }
        } else {
          string.match(idsregex);
          var ids = [Number(RegExp.$1)];
        }
        if (string.match(hideregex)) {
          var hide = true;
        } else {
          var hide = false;
        }
        ...
        /// Edit by waynee95
        if (cmdInfo[4].match(conditionRegex)) {
          var condition = RegExp.$1;
          var evalCondition = true;
        } else {
          var evalCondition = false;
        }
        /// Edit by waynee95
        ...
        var bCmd = new BattleCommand(cmd, ids, params, icon, hide, condition);
        if (evlIds) {
          bCmd.enableIdEval();
        }
        if (evlIcon) {
        ...
        if (evlParams) {
          bCmd.enableParamEval();
        }
        /// Edit by waynee95
        if (evalCondition) {
          bCmd.enableConditionEval();
        }
        /// Edit by waynee95
...
Game_Actor.prototype.battleCommandList = function(currentCommands) {
  var classCommands =
    currentCommands || $dataClasses[this._classId].battleCommands.slice(0);
  var res = [];
...
if (Bobstah.Param.BattleCommandList_SkillMenuSTypes === 1) {
  Bobstah.BattleCmds.WindowSkillType_makeCommandList =
  ...
  Window_SkillType.prototype.makeCommandList = function() {
    if (this._actor) {
      ...
      this._added = [];
      if (!commands) {
        return Bobstah.BattleCmds.WindowSkillType_makeCommandList.call(this);
      }
...
// Window_SkillList
//=============================================================================
Bobstah.BattleCmds.WindowSkillList_setStypeId =
  Window_SkillList.prototype.setStypeId;
...
Bobstah.BattleCmds.WindowSkillList_includes =
...
Window_SkillList.prototype.multipleSkills = function(stypeId) {
  ...
  if (typeof stypeId === "number") {
    return false;
  }
  if (typeof stypeId === "undefined") {
    return false;
  }
  if (stypeId.length > 0) {
    return true;
...
// Window_ActorCommand
//=============================================================================
Bobstah.BattleCmds.WindowActorCommand_initialize =
...
Window_ActorCommand.prototype.initialize = function() {
  ...
  this._commandCostOutline =
    Bobstah.Param.BattleCommandList_CostOutlineStrength;
...
Window_ActorCommand.prototype.drawCommandCost = function(skill, x, y, width) {
  ...
  var by =
    y +
    (this.lineHeight() - this.commandCostFontSize()) -
    this.textPadding() * 2;
...
Bobstah.BattleCmds.WindowActorCommand_itemTextAlign =
  Window_ActorCommand.prototype.itemTextAlign;
...
Bobstah.BattleCmds.WindowActorCommand_drawItem =
...
Bobstah.BattleCmds.WindowActorCommand_addCommand =
...
Window_ActorCommand.prototype.select = function(index) {
  ...
  if (Bobstah.Param.BattleCommandList_ShowHelpWindow === 0 || index === -1) {
    return res;
  }
...
Bobstah.BattleCmds.WindowActor_processOk =
  Window_ActorCommand.prototype.processOk;
...
Bobstah.BattleCmds.WindowActorCommand_makeCommandList =
...
Bobstah.BattleCmds.WindowActorCommand_addAttackCommand =
  Window_ActorCommand.prototype.addAttackCommand;
Window_ActorCommand.prototype.addAttackCommand = function() {
  if (this._cmdContext === null) {
    return Bobstah.BattleCmds.WindowActorCommand_addAttackCommand.call(this);
  }
  ...
  var icon =
    this._cmdContext.iconOverride ||
    $dataSkills[this._actor.attackSkillId()].iconIndex ||
    null;
  ...
  this.addCommand(
    name,
    "attack",
    this._actor.canAttack() && condition,
    null,
    icon
  );
  /// Edit by waynee95
...
Bobstah.BattleCmds.WindowActorCommand_addSkillCommands =
  Window_ActorCommand.prototype.addSkillCommands;
Window_ActorCommand.prototype.addSkillCommands = function() {
  if (this._cmdContext === null) {
    return Bobstah.BattleCmds.WindowActorCommand_addSkillCommands.call(this);
  }
  var skillTypes = this._actor.addedSkillTypes();
  skillTypes.sort(function(a, b) {
    return a - b;
  ...
  skillTypes.forEach(function(stypeId) {
    ...
    /// Edit by waynee95
    this.addCommand(name, "skill", !res && condition, stypeId, icon);
    /// Edit by waynee95
  }, this);
  return true;
};

Bobstah.BattleCmds.WindowActorCommand_addGuardCommand =
  Window_ActorCommand.prototype.addGuardCommand;
Window_ActorCommand.prototype.addGuardCommand = function() {
  if (this._cmdContext === null) {
    return Bobstah.BattleCmds.WindowActorCommand_addGuardCommand.call(this);
  }
  ...
  var icon =
    this._cmdContext.iconOverride ||
    $dataSkills[this._actor.guardSkillId()].iconIndex ||
    null;
  ...
  this.addCommand(
    name,
    "guard",
    this._actor.canGuard() && condition,
    null,
    icon
  );
  /// Edit by waynee95
...
Bobstah.BattleCmds.WindowActorCommand_addItemCommand =
  Window_ActorCommand.prototype.addItemCommand;
Window_ActorCommand.prototype.addItemCommand = function() {
  if (this._cmdContext === null) {
    return Bobstah.BattleCmds.WindowActorCommand_addItemCommand.call(this);
  }
  ...
  /// Edit by waynee95
  this.addCommand(name, "item", condition, null, icon);
  /// Edit by waynee95
...
Window_ActorCommand.prototype.addSkillCommand = function() {
  ...
  for (var i = 0; i < stypeIds.length; i++) {
    ...
    var stypeName =
      this._cmdContext.params || $dataSystem.skillTypes[stypeId] || "???";
    var res = this._actor.isSkillTypeSealed(stypeId);
    ...
    /// Edit by waynee95
    this.addCommand(stypeName, "skill", !res && condition, stypeId, icon);
    /// Edit by waynee95
  }
  return true;
};
...
Window_ActorCommand.prototype.addMultiSkillCommand = function() {
  ...
  /// Edit by waynee95
  this.addCommand(skillName, "skill", condition, stypes, icon);
  /// Edit by waynee95
...
Window_ActorCommand.prototype.addCustomSkillCommand = function() {
  ...
  for (var i = 0; i < skillIds.length; i++) {
    ...
    var skillName =
      this._cmdContext.params || $dataSkills[skillId].name || "???";
    ...
    if (
      this._actor.isLearnedSkill(skillId) ||
      this._actor.addedSkills().contains(skillId)
    ) {
      ...
      this.addCommand(skillName, "customSkill", res && condition, skill, icon);
    }
  }
  /// Edit by waynee95
  return true;
...
Window_ActorCommand.prototype.addCustomItemCommand = function() {
  ...
  for (var i = 0; i < itemIds.length; i++) {
    ...
    if ($gameParty.hasItem(item, true)) {
      ...
      this.addCommand(itemName, "customItem", res && condition, item, icon);
    }
    /// Edit by waynee95
  }
  return true;
...
Window_ActorCommand.prototype.addLastSkillCommand = function() {
  return this.addFirstSkillCommand(
    Array.prototype.slice.call(this._cmdContext.ids).reverse()
  );
};
...
// Scene_Battle
//=============================================================================
Bobstah.BattleCmds.SceneBattle_createActorCommandWindow =
...
Scene_Battle.prototype.createActorCommandWindow = function() {
  ...
  this._actorCommandWindow.setHandler(
    "customSkill",
    this.onCustomSkillOk.bind(this)
  );
  this._actorCommandWindow.setHandler(
    "customItem",
    this.onCustomItemOk.bind(this)
  );
  if (Bobstah.BattleCmds.Custom.length > 0) {
    for (
      var customId = 0;
      customId < Bobstah.BattleCmds.Custom.length;
      customId++
    ) {
...
if (Imported["VE - Mix Actions"]) {
  ...
  Bobstah.BattleCmds.VEMixWindowActorCommand_processCommandEntry =
    Window_ActorCommand.prototype.processCommandEntry;
  Window_ActorCommand.prototype.processCommandEntry = function(cmd) {
    if (cmd === "mix") {
      return this.addMixCommand();
    } else {
      Bobstah.BattleCmds.VEMixWindowActorCommand_processCommandEntry.call(
        this,
        cmd
      );
    }
...
if (Imported.YEP_X_ChangeBattleEquip) {
  Bobstah.BattleCmds.YEPChangeWindowActorCommand_processCommandEntry =
    Window_ActorCommand.prototype.processCommandEntry;
  Window_ActorCommand.prototype.processCommandEntry = function(cmd) {
    if (cmd.command.toLowerCase() === "equip") {
      return this.addEquipChangeCommand();
    } else {
      Bobstah.BattleCmds.YEPChangeWindowActorCommand_processCommandEntry.call(
        this,
        cmd
      );
    }
  ...
  Bobstah.BattleCmds.YEPChangeWindowActorCommand_addEquipChangeCommand =
    Window_ActorCommand.prototype.addEquipChangeCommand;
  Window_ActorCommand.prototype.addEquipChangeCommand = function() {
    if (this._cmdContext === null) {
      return Bobstah.BattleCmds.YEPChangeWindowActorCommand_addEquipChangeCommand.call(
        this
      );
    }
    ...
    var icon = this._cmdContext.iconOverride || null;
    var name = this._cmdContext.params || Yanfly.Param.CBECmd;
    this.addCommand(
      name,
      "equip change",
      this._actor.canBattleEquipChange() && condition,
      null,
      icon
    );
    return true;
  ...
  Bobstah.BattleCmds.Scene_Battle_createActorCommandWindow =
    Scene_Battle.prototype.createActorCommandWindow;
  Scene_Battle.prototype.createActorCommandWindow = function() {
...
if (Imported.YEP_X_ActorPartySwitch) {
  Bobstah.BattleCmds.YEPActorSwitchActorCommand_processCommandEntry =
    Window_ActorCommand.prototype.processCommandEntry;
  Window_ActorCommand.prototype.processCommandEntry = function(cmd) {
    if (cmd.command.toLowerCase() === "actorswitch") {
      return this.addActorSwitchChangeCommand();
    } else {
      Bobstah.BattleCmds.YEPActorSwitchActorCommand_processCommandEntry.call(
        this,
        cmd
      );
    }
  ...
  Bobstah.BattleCmds.YEPActorSwitchCommand_addEquipChangeCommand =
    Window_ActorCommand.prototype.addEquipChangeCommand;
  Window_ActorCommand.prototype.addActorSwitchChangeCommand = function() {
    if (this._cmdContext === null) {
      return Bobstah.BattleCmds.YEPActorSwitchCommand_addEquipChangeCommand.call(
        this
      );
    }
    ...
    this.addCommand(
      name,
      "partyswitch",
      this.isActorPartySwitchEnabled() && condition,
      null,
      icon
    );
    return true;
...
if (Imported.YEP_EquipBattleSkills) {
  Bobstah.BattleCmds.YEPEquipBattleSkills_processCommandEntry =
    Window_ActorCommand.prototype.processCommandEntry;
  Window_ActorCommand.prototype.processCommandEntry = function(cmd) {
    if (cmd.command.toLowerCase() === "equipskills") {
      return this.addEquipBattleSkillsCommand();
    } else if (cmd.command.toLowerCase() === "equipskill") {
      return this.addCustomEquipSkillCommand();
    } else {
      Bobstah.BattleCmds.YEPEquipBattleSkills_processCommandEntry.call(
        this,
        cmd
      );
    }
  ...
  Bobstah.BattleCmds.YEPActorSwitchCommand_addEquipBattleSkillsCommand =
    Window_ActorCommand.prototype.addEquipChangeCommand;
  Window_ActorCommand.prototype.addEquipBattleSkillsCommand = function() {
    if (this._cmdContext === null) {
      return Bobstah.BattleCmds.YEPActorSwitchCommand_addEquipBattleSkillsCommand.call(
        this
      );
    }
    ...
    var icon = this._cmdContext.iconOverride || null;
    var name = this._cmdContext.params || Yanfly.Param.EBSCmdName;
    this.addCommand(
      name,
      "skill",
      $gameSystem.isEnableEquipBattleSkills() && condition,
      "battleSkills",
      icon
    );
    return true;
  ...
  Window_ActorCommand.prototype.addCustomEquipSkillCommand = function() {
    var slotId = this._cmdContext.ids[0];
    var skill = this._actor.battleSkills()[slotId];
    if (!skill) {
      return false;
    }
    ...
    if (this._actor.battleSkills().contains(skill)) {
      var res = this._actor.meetsSkillConditions(skill);
      if (this._cmdContext.hide === true) {
        if (res === false) {
          return false;
...
if (Imported.YEP_X_InBattleStatus) {
  Bobstah.BattleCmds.YEP_X_InBattleStatus_processCommandEntry =
    Window_ActorCommand.prototype.processCommandEntry;
  Window_ActorCommand.prototype.processCommandEntry = function(cmd) {
    if (cmd.command.toLowerCase() === "battlestatus") {
      return this.addInBattleStatusCommand();
    } else {
      Bobstah.BattleCmds.YEP_X_InBattleStatus_processCommandEntry.call(
        this,
        cmd
      );
    }
  ...
  Bobstah.BattleCmds.YEP_X_InBattleStatus_addInBattleStatusCommand =
    Window_ActorCommand.prototype.addEquipChangeCommand;
  Window_ActorCommand.prototype.addInBattleStatusCommand = function() {
    if (this._cmdContext === null) {
      return Bobstah.BattleCmds.YEP_X_InBattleStatus_addInBattleStatusCommand.call(
        this
      );
    }
    ...
    var icon = this._cmdContext.iconOverride || null;
    var name = this._cmdContext.params || Yanfly.Param.IBSCmdName;
    this.addCommand(name, "inBattleStatus", condition, null, icon);
    return true;
  };

  Bobstah.BattleCmds.YEP_X_InBattleStatus_createActorCommandWindow =
    Scene_Battle.prototype.createActorCommandWindow;
  Scene_Battle.prototype.createActorCommandWindow = function() {
