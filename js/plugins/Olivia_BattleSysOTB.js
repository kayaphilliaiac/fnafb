...
DataManager.otbBuffDebuffAgiConvert = function(item) {
    if (BattleManager.isOTB() && Olivia.OctoBattle.OTB.BuffDebuffAgiConvert && !item._otbBuffDebuffAgiConvert) {
...
Sprite_OTBTurnOrder.prototype.loadBattlerSpriteBitmap = function() {
    ...
    if (this._battler.isActor()) {
        ...
        if (Imported.YEP_X_AnimatedSVEnemies && this._battler.hasSVBattler()) {
...
Sprite_OTBTurnOrder.prototype.updateBattlerBitmap = function() {
    if (this._battler.isEnemy()) {
        if (this._battlerName !== this._battler.battlerName() || this._battlerHue !== this._battler.battlerHue()) {
            this._updateReady = false;
