//=============================================================================
// MOG_BattleHud.js   -   (Template 09)
//=============================================================================

/*:
 * @plugindesc (v5.03 *) Permite customizar o layout de batalha.
 * @author Moghunter
 *
 * @param -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 * @desc
 ...
 * ============================================================================
 * - (version 5.03) 
 * (BUG FIX) - Correção do tempo da animação da face devido ao update anterior. 
 *
 * - (version 5.01) 
 * (NEW) - Adicionado o efeito de respirar nas faces.
 * (UPD) - Melhoria no tempo da animação das faces.
 *
 *
 * - (version 5.0) 
 * (NEW) - Reformulação dos plugins Parameters para a versão do RPG Maker MV 1.5+
 * (NEW) - A definição do ângulo dos sprites agora é baseado de 0 a 360.
 * (BUG FIX) - Correção de apresentar o dano durante a animação no modo
 *             Front View.
 *
 */
...
// * addBuff
//==============================
var _alias_mog_bhud_addBuff = Game_BattlerBase.prototype.addBuff
Game_BattlerBase.prototype.addBuff = function(stateId) {
    _alias_mog_bhud_addBuff.call(this,stateId);
	this.need_refresh_bhud_states = true;
};
...
// * addDebuff
//==============================
var _alias_mog_bhud_addDebuff = Game_BattlerBase.prototype.addDebuff
Game_BattlerBase.prototype.addDebuff = function(stateId) {
    _alias_mog_bhud_addDebuff.call(this,stateId);
	this.need_refresh_bhud_states = true;
};
...
// * removeBuff
//==============================
var _alias_mog_bhud_removeBuff = Game_BattlerBase.prototype.removeBuff
Game_BattlerBase.prototype.removeBuff = function(stateId) {
    _alias_mog_bhud_removeBuff.call(this,stateId);
	this.need_refresh_bhud_states = true;
};
...
Scene_Base.prototype.createBattleHud = function() {
	...
	if ($gameParty.battleMembers().contains($gameActors.actor(20)) == true && $gameParty.battleMembers().length == 1) {
		Moghunter.bhud_face_pos_x = 115;
		Moghunter.bhud_face_pos_y = 80;		
	} else if ($gameParty.battleMembers().contains($gameActors.actor(69)) == true && $gameParty.battleMembers().length == 1) {
		Moghunter.bhud_face_pos_x = 115;
		Moghunter.bhud_face_pos_y = 80;		
	} else if ($gameParty.battleMembers().contains($gameActors.actor(71)) == true && $gameParty.battleMembers().length == 1) {
		Moghunter.bhud_face_pos_x = 115;
		Moghunter.bhud_face_pos_y = 80;		
	} else if ($gameParty.battleMembers().contains($gameActors.actor(120)) == true && $gameParty.battleMembers().length == 1) {
		Moghunter.bhud_face_pos_x = 115;
		Moghunter.bhud_face_pos_y = 80;
	} else if ($gameParty.battleMembers().contains($gameActors.actor(121)) == true && $gameParty.battleMembers().length == 1) {
		Moghunter.bhud_face_pos_x = 115;
		Moghunter.bhud_face_pos_y = 80;			
	} else {
	Moghunter.bhud_face_pos_x = 72;
	Moghunter.bhud_face_pos_y = 40;
	};
...
Scene_Battle.prototype.create_layout_window = function() {
	...
	if (String(Moghunter.bhud_party_layout) === "true") {
		this._party_layout = new Sprite(ImageManager.loadBHud("Layout_PartyFB" + $gameVariables.value(139)))
...
Battle_Hud.prototype.load_img = function() {
	if ($gameParty.battleMembers().contains($gameActors.actor(20)) == true && $gameParty.battleMembers().length == 1) {
		this._layout_img = ImageManager.loadBHud("Layout_Springtrap");
	} else {
		if ($gameParty.battleMembers().contains($gameActors.actor(69)) == true && $gameParty.battleMembers().length == 1) {
		this._layout_img = ImageManager.loadBHud("Layout_Springtrap");
		} else {
			if ($gameParty.battleMembers().contains($gameActors.actor(71)) == true && $gameParty.battleMembers().length == 1) {
			this._layout_img = ImageManager.loadBHud("Layout_Springtrap");
				} else {
					if ($gameParty.battleMembers().contains($gameActors.actor(120)) == true && $gameParty.battleMembers().length == 1) {
					this._layout_img = ImageManager.loadBHud("Layout_ToyFreddy2");
						} else {
							if ($gameParty.battleMembers().contains($gameActors.actor(121)) == true && $gameParty.battleMembers().length == 1) {
							this._layout_img = ImageManager.loadBHud("Layout_ToyFreddy");
								} else {
									this._layout_img = ImageManager.loadBHud("LayoutFB" + $gameVariables.value(139));
									}
						}
				}
	}
	...
	if ($gameParty.battleMembers().contains($gameActors.actor(20)) == true && $gameParty.battleMembers().length == 1) {
		if (String(Moghunter.bhud_hp_meter_visible) == "true") {this._hp_meter_img = ImageManager.loadBHud("HP_MeterSpringtrap");};
		if (String(Moghunter.bhud_mp_meter_visible) == "true") {this._mp_meter_img = ImageManager.loadBHud("MP_MeterSpringtrap");};
		if (String(Moghunter.bhud_tp_meter_visible) == "true") {this._tp_meter_img = ImageManager.loadBHud("TP_MeterSpringtrap");};
		if (String(Moghunter.bhud_at_meter_visible) == "true") {this._at_meter_img = ImageManager.loadBHud("ATB_Meter");};
		if (String(Moghunter.bhud_hp_number_visible) == "true") {this._hp_number_img = ImageManager.loadBHud("HP_NumberSpringtrap");};
		if (String(Moghunter.bhud_mp_number_visible) == "true") {this._mp_number_img = ImageManager.loadBHud("MP_NumberSpringtrap");};
		if (String(Moghunter.bhud_tp_number_visible) == "true") {this._tp_number_img = ImageManager.loadBHud("TP_NumberSpringtrap");};
		...
		this._turn_img = ImageManager.loadBHud("TurnSpringtrap");
	} else {
	if ($gameParty.battleMembers().contains($gameActors.actor(69)) == true && $gameParty.battleMembers().length == 1) {
		if (String(Moghunter.bhud_hp_meter_visible) == "true") {this._hp_meter_img = ImageManager.loadBHud("HP_MeterSpringtrap");};
		if (String(Moghunter.bhud_mp_meter_visible) == "true") {this._mp_meter_img = ImageManager.loadBHud("MP_MeterSpringtrap");};
		...
		this._turn_img = ImageManager.loadBHud("TurnSpringtrap");
			...
			if ($gameParty.battleMembers().contains($gameActors.actor(71)) == true && $gameParty.battleMembers().length == 1) {
				...
				this._turn_img = ImageManager.loadBHud("TurnSpringtrap");
					...
					if ($gameParty.battleMembers().contains($gameActors.actor(120)) == true && $gameParty.battleMembers().length == 1) {
						if (String(Moghunter.bhud_hp_meter_visible) == "true") {this._hp_meter_img = ImageManager.loadBHud("HP_MeterFB2big");};
						if (String(Moghunter.bhud_mp_meter_visible) == "true") {this._mp_meter_img = ImageManager.loadBHud("MP_MeterFB2big");};
						if (String(Moghunter.bhud_tp_meter_visible) == "true") {this._tp_meter_img = ImageManager.loadBHud("TP_MeterFB2big");};
						if (String(Moghunter.bhud_at_meter_visible) == "true") {this._at_meter_img = ImageManager.loadBHud("ATB_Meter");};
						if (String(Moghunter.bhud_hp_number_visible) == "true") {this._hp_number_img = ImageManager.loadBHud("HP_NumberSpringtrap");};
						if (String(Moghunter.bhud_mp_number_visible) == "true") {this._mp_number_img = ImageManager.loadBHud("MP_NumberSpringtrap");};
						if (String(Moghunter.bhud_tp_number_visible) == "true") {this._tp_number_img = ImageManager.loadBHud("TP_NumberSpringtrap");};
						...
						this._turn_img = ImageManager.loadBHud("TurnSpringtrap");
							...
							if ($gameParty.battleMembers().contains($gameActors.actor(121)) == true && $gameParty.battleMembers().length == 1) {
								...
								this._turn_img = ImageManager.loadBHud("TurnSpringtrap");
									...
									if (String(Moghunter.bhud_hp_meter_visible) == "true") {this._hp_meter_img = ImageManager.loadBHud("HP_MeterFB" + $gameVariables.value(139));};
									if (String(Moghunter.bhud_mp_meter_visible) == "true") {this._mp_meter_img = ImageManager.loadBHud("MP_MeterFB" + $gameVariables.value(139));};
									if (String(Moghunter.bhud_tp_meter_visible) == "true") {this._tp_meter_img = ImageManager.loadBHud("TP_MeterFB" + $gameVariables.value(139));};
									if (String(Moghunter.bhud_at_meter_visible) == "true") {this._at_meter_img = ImageManager.loadBHud("ATB_Meter");};
...
Battle_Hud.prototype.set_hud_position = function() {
	 ...
	 if ($gameSystem._bhud_position[this._hud_id]) {
			if ($gameParty.battleMembers().contains($gameActors.actor(20)) == true) {
				this._pos_x = 116;
				this._pos_y = 454;
			} else {
				if ($gameParty.battleMembers().contains($gameActors.actor(69)) == true) {
					this._pos_x = 116;
					this._pos_y = 454;
				} else {
					if ($gameParty.battleMembers().contains($gameActors.actor(71)) == true) {
						this._pos_x = 116;
						this._pos_y = 454;
					} else {
						if ($gameParty.battleMembers().contains($gameActors.actor(120)) == true) {
							this._pos_x = 116;
							this._pos_y = 454;
						} else {
							if ($gameParty.battleMembers().contains($gameActors.actor(121)) == true) {
								this._pos_x = 116;
								this._pos_y = 454;
							} else {
								if ($gameParty.battleMembers().contains($gameActors.actor(22)) == true && $gameParty.battleMembers().length > 1) {
									this._pos_x = 10;
									this._pos_y = 454;
								} else {
...
Battle_Hud.prototype.create_sprites = function() {
	if ($gameParty.battleMembers().contains($gameActors.actor(20)) == true && $gameParty.battleMembers().length == 1) {
		Moghunter.bhud_hp_meter_pos_x = 262;
		Moghunter.bhud_hp_meter_pos_y = 11;
		Moghunter.bhud_mp_meter_pos_x = 262;
		Moghunter.bhud_mp_meter_pos_y = 50;
		Moghunter.bhud_tp_meter_pos_x = 262;
		Moghunter.bhud_tp_meter_pos_y = 89;
		Moghunter.bhud_hp_number_pos_x = 502;
		Moghunter.bhud_hp_number_pos_y = 11;
		Moghunter.bhud_mp_number_pos_x = 502;
		Moghunter.bhud_mp_number_pos_y = 50;
		Moghunter.bhud_tp_number_pos_x = 502;
		Moghunter.bhud_tp_number_pos_y = 89;
		Moghunter.bhud_states_pos_x = 259;
		Moghunter.bhud_states_pos_y = 122;
	} else if ($gameParty.battleMembers().contains($gameActors.actor(69)) == true && $gameParty.battleMembers().length == 1) {
		Moghunter.bhud_hp_meter_pos_x = 262;
		Moghunter.bhud_hp_meter_pos_y = 11;
		Moghunter.bhud_mp_meter_pos_x = 262;
		...
		Moghunter.bhud_hp_meter_pos_x = 173;
		Moghunter.bhud_hp_meter_pos_y = 9;
		Moghunter.bhud_mp_meter_pos_x = 173;
		Moghunter.bhud_mp_meter_pos_y = 33;	
		Moghunter.bhud_tp_meter_pos_x = 173;
		Moghunter.bhud_tp_meter_pos_y = 58;	
		Moghunter.bhud_hp_number_pos_x  = 315;
		Moghunter.bhud_hp_number_pos_y  = 7;
		Moghunter.bhud_mp_number_pos_x  = 315;
		Moghunter.bhud_mp_number_pos_y  = 33;
		Moghunter.bhud_tp_number_pos_x  = 315;
		Moghunter.bhud_tp_number_pos_y  = 56;
		Moghunter.bhud_states_pos_x = 355;
		Moghunter.bhud_states_pos_y = 46;	
	};
	...
	if ($gameParty.battleMembers().contains($gameActors.actor(20)) == true || $gameParty.battleMembers().contains($gameActors.actor(69)) == true || $gameParty.battleMembers().contains($gameActors.actor(71)) == true || $gameParty.battleMembers().contains($gameActors.actor(120)) == true || $gameParty.battleMembers().contains($gameActors.actor(121)) == true) {
		this._stateType = 1;
	} else {	
		this._stateType = 0;
	};
...
Battle_Hud.prototype.create_face = function() { 
	...
	if (!this._battler) {return};	
	if ($gameParty.battleMembers().contains($gameActors.actor(20)) == true && $gameParty.battleMembers().length == 1) {
		this._face = new Sprite(ImageManager.loadBHud("Face_Springtrap"));
	} else {
		if ($gameParty.battleMembers().contains($gameActors.actor(69)) == true && $gameParty.battleMembers().length == 1) {
			this._face = new Sprite(ImageManager.loadBHud("Face_PhantomPuppet"));
		} else {
			if ($gameParty.battleMembers().contains($gameActors.actor(71)) == true && $gameParty.battleMembers().length == 1) {
				this._face = new Sprite(ImageManager.loadBHud("Face_FinalFreddy"));
			} else {
				if ($gameParty.battleMembers().contains($gameActors.actor(120)) == true && $gameParty.battleMembers().length == 1) {
					this._face = new Sprite(ImageManager.loadBHud("Face_ToyFreddy"));
				} else {
					if ($gameParty.battleMembers().contains($gameActors.actor(121)) == true && $gameParty.battleMembers().length == 1) {
						this._face = new Sprite(ImageManager.loadBHud("Face_ToyFreddy"));
					} else {
...
Battle_Hud.prototype.refresh_states2 = function() {
	...
	var m = Math.min(Math.max(this._battler.allIcons().length,0),trueStatesMax);
