...
//=============================================================================
 /*:
 * @plugindesc When a player is in the proximity of a certain event, the
 * event will start chasing or fleeing from the player.
 ...
 *   this._fleeRange = x        Event will flea from player if reaching x range.
