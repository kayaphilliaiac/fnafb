...
Yanfly.Quest.version = 1.00;

//=============================================================================
 /*:
 * @plugindesc v1.00 Insert a quest journal system into your game!
...
Game_Interpreter.prototype.processQuestPluginCommands = function(line) {
  ...
  } else if (line.match(/SET COMPLETED[ ](\d+)/i)) {
    $gameSystem.questSetCompleted(parseInt(RegExp.$1));
  } else if (line.match(/SET FAILED[ ](\d+)/i)) {
    $gameSystem.questSetFailed(parseInt(RegExp.$1));
  } else if (line.match(/SET AVAILABLE[ ](\d+)/i)) {
    $gameSystem.questSetFailed(parseInt(RegExp.$1));
