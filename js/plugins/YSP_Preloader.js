...
ysp.Preloader.MAP_BASED = {
    ...
    47: {
        IMAGES: [
        'pictures/titleselect1',
        'pictures/titleselect2',
        'pictures/titleselect3',
        'pictures/titleselect4',
        'pictures/titleselect5',
        'pictures/titleselect6',
        'pictures/titleselect7',
        'pictures/titleselect8',
        'pictures/titleselect9',
        'pictures/titleselect10',
        'pictures/cc_fnafb1',
        'pictures/cc_fnafb2',
        'pictures/cc_fnafb3',
        'pictures/cc_fnafba',
    ...
    15: {
        IMAGES: [
        'pictures/cc_fnafb1',
        'pictures/fnafb1image',
        'pictures/fnafb1image2',
        'pictures/fnafb1image3',
        'pictures/fnafb1titleoverlay',
        'pictures/titleselect',
        'pictures/titleselectfnafb1',
        'pictures/ScanlinesThick'
        ],
    ...
    27: {
        IMAGES: [
            'pictures/cc_fnafb2',
            'pictures/cc_fnafb2wbon',
            'pictures/cc_fnafb2wchic',
            'pictures/cc_fnafb2wfred',
            'pictures/fnafb2image',
            'pictures/fnafb2image2',
            'pictures/fnafb2titleoverlay',
            'pictures/titleselectfnafb2'
        ],
    ...
    52: {
        IMAGES: [
            'pictures/fnafb3image',
            'pictures/fnafb3image2',
            'pictures/fnafb3titleoverlay',
            'pictures/titleselectfnafb3',
            'pictures/cc_fnafb3'
        ],
    ...
    162: {
        IMAGES: [
            'pictures/ScenarioItems',
            'pictures/ScenarioArrowLeft',
            'pictures/ScenarioArrowRight',
            'pictures/ScenarioUnknown',
            'pictures/ScenarioBusinessCard',
            'pictures/ScenarioSkeletonChair',
            'pictures/ScenarioArcadePass',
            'pictures/ScenarioChronoEnergy',
            'pictures/ScenarioFakeSunglasses',
            'pictures/ScenarioPowerSpark',
            'pictures/ScenarioCalendar',
            'pictures/ScenarioPhantomShard'
        ],
